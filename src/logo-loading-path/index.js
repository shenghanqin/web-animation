    ...
    return (
      <div className={cx(`${prefixClass}`, { [`${prefixClass}-white`]: skin !== 'blue' })} style={style}>
        <svg className={cx(`${prefixClass}-svg`)} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
          ...
          <g>
            <path className={cx(`${prefixClass}-ring ${prefixClass}-ring-1`)} fill="none" stroke="#008CED" d="M50,300 A290,290, 0,0,1, 630,300 M630,300 A290,290, 0,0,1, 50,300" strokeWidth="120" mask={`url(#${prefixClass}-mask)`} />
            {/* <path className={cx(`${prefixClass}-ring ${prefixClass}-ring-2`)} fill="none" stroke="#008CED" d="" strokeWidth="120" mask={`url(#${prefixClass}-mask)`} /> */}
          </g>
