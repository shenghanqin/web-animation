    ...
    return (
      <div className={cx(`${prefixClass}`)} style={style}>
        <svg className={cx(`${prefixClass}-svg`)} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
          ...
          <path className={cx(`${prefixClass}-ring ${prefixClass}-ring-1`)} fill="none" stroke={iconColor} d="M50 300 A290,290, 0,1,1, 50.000001858166243,300.02129301676624" strokeWidth="100" mask={`url(#${prefixClass}-mask)`} />
