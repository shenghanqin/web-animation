...
import CssVarComp from '@components/play-icon-1-border'
import CssVar from './examples/CssVar'
import README from './examples/CssVar.md'
import CssVarExampleCode from '!raw-loader!./examples/CssVar'
...
storiesOf('样式组件|CSS变量 评价', module)
